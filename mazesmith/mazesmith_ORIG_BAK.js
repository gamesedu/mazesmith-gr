...
function setKCode() {
  kCode[0] = keys[0].charCodeAt(0);
  kCode[1] = keys[1].charCodeAt(0);
  kCode[2] = keys[2].charCodeAt(0);
  kCode[3] = keys[3].charCodeAt(0);
